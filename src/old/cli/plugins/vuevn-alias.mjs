...
export function createVueVNAliasPlugin(options = {}) {
  ...
  return {
    ...
    config(config) {
      ...
      // New brand alias
      config.resolve.alias['@crimsonquill/cli'] = toPosix(cliRoot);
      ...
      // Alias pour l'engine
      config.resolve.alias['@crimsonquill/engine_src'] = toPosix(path.join(cliRoot, 'engine_src'));
...
export default { createVueVNAliasPlugin };
