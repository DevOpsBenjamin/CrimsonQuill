  ...
  return {
    ...
    plugins: [
      ...
      // Custom plugin to move HTML to correct location
      {
        ...
        writeBundle() {
          const wrongPath = path.join(outAbs, 'node_modules/@crimsonquill/cli/vite-build/index.html');
    ...
    css: {
      postcss: {
        plugins: [
          (() => {
            // Load shared Tailwind base config and override content to avoid scanning node_modules
